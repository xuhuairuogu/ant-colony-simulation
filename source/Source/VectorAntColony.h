...
class VectorAntColony : public AntColony
{
public:
	VectorAntColony(void);
	VectorAntColony(uint BugTexture, Grid* grid, FoodManager* food_manager);
	virtual ~VectorAntColony(void);
	
	void Update(float delta_time);
	VectorAnt* AddVectorAnt(int2 pos);
